          ...
          if (current_line.length() == 0)
          {
            ...
            client.println("\
              ...
              <body>\
                  ...
                  <button id='anticlockButton'><i class='fa-solid fa-undo'></i></button>\
                  <button id='forwardsButton'><i class='fa-solid fa-arrow-up'></i></button>\
                  <button id='clockwiseButton'><i class='fa-solid fa-repeat'></i></button>\
                  ...
                  <script>\
                      ...
                      \
                      let anticlockButton = document.getElementById('anticlockButton');\
                      let forwardsButton = document.getElementById('forwardsButton');\
                      let clockwiseButton = document.getElementById('clockwiseButton');\
                      ...
                      anticlockButton.onclick = function() {\
                          \
                          let localIP = window.location.host;\
                          let address = 'http://' + localIP + '/A' + lpad(255, 3);\
                          let xmlHttp = new XMLHttpRequest();\
                          \
                          console.log('Sending XMLHttpRequest: GET ' + address);\
                          xmlHttp.open('GET', address, false);\
                      ...
                      clockwiseButton.onclick = function() {\
                          \
                          let localIP = window.location.host;\
                          let address = 'http://' + localIP + '/C' + lpad(127, 3);\
                          let xmlHttp = new XMLHttpRequest();\
                          \
                          console.log('Sending XMLHttpRequest: GET ' + address);\
                          xmlHttp.open('GET', address, false);\
                      ...
                      forwardsButton.onclick = function() {\
                          \
                          let localIP = window.location.host;\
                          let address = 'http://' + localIP + '/F' + lpad(64, 3);\
                          let xmlHttp = new XMLHttpRequest();\
                          \
                          console.log('Sending XMLHttpRequest: GET ' + address);\
                          xmlHttp.open('GET', address, false);\
          ...
          if (poss_get_req == "GET /")
          {
            ...
            if (is_number(poss_slider_value))
            {
              ...
              if (poss_slider_param[0] == 'H')
              {
                ...
                runMotor_R(slider_value * 0.5);
                h_value = slider_value;
              }
              else if (poss_slider_param[0] == 'A')
              {
                runMotor_L(0);
                runMotor_R(200);
              }
              else if (poss_slider_param[0] == 'C')
              {
                runMotor_L(155);
                runMotor_R(0);
              }
