            ...
            client.println("\
              ...
              <body>\
                  ...
                  <div class='slidecontainer'>\
                      ...
                      <input type='range' min='0' max='180' value='90' class='slider' id='lServoSlider' style='color: #0000FF'>\
                  </div>\
                  <div class='slidecontainer'>\
                      <p>Right servo: <span id='rServoValueDisplay'></span></p>\
                      <input type='range' min='0' max='180' value='90' class='slider' id='rServoSlider' style='color: #0000FF'>\
                  </div>\
                  <script>\
